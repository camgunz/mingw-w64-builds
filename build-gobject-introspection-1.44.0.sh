...
cp ${BUILD_DIR}/bin/libgobject-2.0-0.dll /bin/libgobject-2.0-0.dll
cp ${BUILD_DIR}/bin/libgmodule-2.0-0.dll /bin/libgmodule-2.0-0.dll
cp ${BUILD_DIR}/bin/libglib-2.0-0.dll /bin/libglib-2.0-0.dll
cp ${BUILD_DIR}/bin/libffi-6.dll /lib/libffi-6.dll
...
# cp giscanner/shlibs.py giscanner/shlibs.py.orig

# patch -p1 -f -i ${PATCH_DIR}/gobject-introspection-1.44.0-fix-win32.patch
